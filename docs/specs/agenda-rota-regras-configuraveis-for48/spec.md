...
- RF-012: mensagens do assistente inteligente de proximidade devem detalhar a composicao do deslocamento (trecho anterior + trecho posterior = total) para evitar ambiguidade operacional.
...
- CA-011: mensagem de proximidade exibe composicao do deslocamento no formato `anterior + posterior = total`, tanto no aviso principal quanto no panorama de ofertas.
