...
| CA-011 | teste do validador de status e workflows com segredos separados de stage/producao | aprovado |
...
- suite completa em stage: 348 testes aprovados;
- candidato de producao combinado com `origin/main`: 359 testes aprovados com `TZ=UTC`;
...
- frontend do candidato de producao: lint, TypeScript e build aprovados, com 34 paginas geradas;
...
- segredos `OPENAI_API_KEY_STAGE` e `OPENAI_API_KEY_PROD` registrados separadamente no GitHub Actions e workflows validados;
