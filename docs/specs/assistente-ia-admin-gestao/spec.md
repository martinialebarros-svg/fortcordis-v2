...
- NFR-034 (autorizacao): ocultar a UI nao substitui o guard `admin` do backend.
- NFR-035 (clinico): rascunho sempre informa que requer revisao e que o laudo oficial nao foi modificado.
