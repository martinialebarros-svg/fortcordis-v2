...
- `venv/bin/python -m unittest tests.test_eco_study_extraction_service tests.test_eco_study_import_jobs tests.test_eco_study_import_migration tests.test_image_header_import_service tests.test_xml_import_jobs tests.test_sdd_guardrail -v`: 30/30 testes passaram.
...
- `venv/bin/python -m unittest discover -s tests -p 'test_*.py'`: suite backend completa passou, 306/306 testes.
