  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-16 text-slate-100 sm:px-10">
      <div className="mx-auto max-w-3xl rounded-3xl border border-white/15 bg-white/5 p-8 backdrop-blur-sm sm:p-12">
        ...
        <h1 className="text-3xl font-semibold text-white sm:text-4xl">Area da clinica parceira em construcao</h1>
        <p className="mt-4 text-sm leading-relaxed text-slate-300 sm:text-base">
          Este portal reunira download de laudos, andamento de casos e pendencias financeiras.
        </p>
        <Link
          href="/"
